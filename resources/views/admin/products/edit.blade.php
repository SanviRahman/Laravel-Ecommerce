...
<section class="no-padding-top no-padding-bottom">
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12">
                <div class="block">
                    <div class="title"><strong>Edit Product: {{ $product->product_title }}</strong></div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="mb-3">
                                            <!-- CHANGE HERE: asset() instead of asset('storage/') -->
                                        ...
                                        <small class="text-muted">
                                            Current image path: {{ $product->product_image }}
                                        </small>
                                        @else
                                        <div class="mb-3">
                                            <div
                                                style="width: 200px; height: 200px; background: #f8f9fa; border-radius: 4px; display: flex; align-items: center; justify-content: center; border: 1px solid #ddd;">
                                    ...
                                    <div class="form-group">
                                        <label for="product_image" class="form-control-label">Update Image</label>
                                        <div class="custom-file">
                                            <input type="file"
                                                class="custom-file-input @error('product_image') is-invalid @enderror"
                                                id="product_image" name="product_image" accept="image/*">
                                            <label class="custom-file-label" for="product_image">Choose new file</label>
                                            @error('product_image')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
