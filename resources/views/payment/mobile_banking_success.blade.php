    ...
    <div class="container">
        <div class="success-container">
            ...
            <p class="text-center text-muted mb-4">
                Your mobile banking payment has been submitted successfully. Please keep your transaction ID for verification.
            </p>
            ...
            <div class="verification-note">
                ...
                <p class="mb-0">Our team will verify your payment within <strong>2-3 hours</strong>. You will receive a confirmation email once verified.</p>
            </div>
